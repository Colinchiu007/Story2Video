...
| Endpoint | `https://app-bmyoogysfs3l-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| 网关 URL（含 API ID 前缀） | `https://app-bmyoogysfs3l-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api` |
| Method | POST |
| Content-Type | application/json |
| third_part_domain | `app-bmyoogysfs3l-api-Aa2PZnjEw5NL-gateway.appmiaoda.com` |
...
async function callShortSpeechRecognition(
  ...
  const response = await fetch("https://app-bmyoogysfs3l-api-Aa2PZnjEw5NL-gateway.appmiaoda.com/server_api", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
