...
- **Endpoint**：`POST https://app-bmyoogysfs3l-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bmyoogysfs3l-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
