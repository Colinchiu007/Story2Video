...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:vCsEckJiXBk8zZuJPJ3xRg==$4uBXKVByaELXkQYucLpMjNsfaDww1rRxAbZ6qEBsZ0I=:7Eefqsc592KWRPR7TgrhXXTTTXLvly+LdeCJTiX+2s0=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:7iuyIFLvkiojbgu+/ie/MQ==$9Tw7REXRvTTzP2Fs/V6BEPe+sYT7XEETWCL3dTYipIg=:WGcGrNLewNCQdAAMADMSKbVyMaHgDfl4N9Jkjpp0Nkc=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:h+hRdfaXkkdyQhYJUw1VLg==$yvNS7SxvFWt+OQ+jVisykHX56qFVchBYeuP0uNtjU9o=:XJvgjPmpYEcuof+iJ9DGsdS2g9Pbyk557Z0NtfZWZjI=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:wdVcOt2BvTHfK0garbpzug==$kT1gdD+oqPX1W9ixFiPRHklUB+KRFWEa8pbskG7kiR8=:OVXsX8+d6SaKQCJLdbmbNjQN6v2ynaA5bt90TL2XoSg=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:S3EENq3DGCZSoba7vfpAXQ==$z3EjCLgLGseEx6+NxxSwNvqyvle85hw7oHB9+43DCdA=:HPgNhLAC8NtOsM+m0ejJm4G2hzb8uKHur+A7PI9BdR4=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:8Xm8fRa3jTV84J/qOW6bkg==$ePlldD+zSgk9rt6r20ILZSlItvQoec4C55QkknFFm/Y=:YuaIbeFuJLDfJ0lS1lQxGQXMT9tWfUq6g52FRye8JZg=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:hcCKc6KyqrRHGBfcCDBrpA==$zPfKWVZzLd+8zsAKC/fgWpakmopiil4ORLeXBHte2Y4=:6/BQNmRbMX8P6ZVH42f+98fVnVo1y0SeiHBWTeycZmU=';
...
CREATE TABLE "public"."user_settings" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid",
    "ai_source" "text" DEFAULT 'builtin'::"text" NOT NULL,
    "api_base_url" "text",
    "api_key" "text",
    "model_name" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    ...
    "doubao_api_key" "text",
    "jimeng_api_key" "text",
    "doubao_voice_id" "text",
    "doubao_voice_name" "text",
    "bgm_config" "jsonb",
    "model_config" "jsonb",
    "last_voice_id" "text"
);
...
--
-- Name: user_voices; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."user_voices" (
    ...
    "language" "text" DEFAULT 'Chinese'::"text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "error_message" "text"
);
...
CREATE TABLE "public"."video_tasks" (
    ...
    "size" "text" DEFAULT '720x1280'::"text" NOT NULL,
    "seconds" integer DEFAULT 8 NOT NULL,
    "status" "text" DEFAULT 'pending'::"text" NOT NULL,
    ...
    "bgm_url" "text",
    "bgm_volume" integer DEFAULT 5,
    "subtitle_enabled" boolean DEFAULT false,
    "subtitle_font" "text" DEFAULT '"Noto Sans SC", "PingFang SC", "Microsoft YaHei", sans-serif'::"text",
    "subtitle_size" "text" DEFAULT 'size3'::"text",
    "subtitle_style" "text" DEFAULT 'style1'::"text",
    ...
    "generate_base_enabled" boolean DEFAULT true,
    "generate_merged_enabled" boolean DEFAULT true,
    "per_image_duration" integer DEFAULT 6 NOT NULL,
    CONSTRAINT "video_tasks_mode_check" CHECK (("mode" = ANY (ARRAY['text'::"text", 'image'::"text", 'remix'::"text", 'gallery'::"text", 'audio'::"text", 'batch'::"text"])))
);
...
--
-- Name: user_voices user_voices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_voices"
    ADD CONSTRAINT "user_voices_pkey" PRIMARY KEY ("id");
...
--
-- Name: idx_gallery_images_task_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_gallery_images_task_id" ON "public"."gallery_images" USING "btree" ("task_id");


--
-- Name: idx_gallery_images_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_gallery_images_user_id" ON "public"."gallery_images" USING "btree" ("user_id");
...
CREATE INDEX "idx_video_tasks_user_id" ON "public"."video_tasks" USING "btree" ("user_id");
...
--
-- Name: gallery_images on_gallery_images_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "on_gallery_images_updated" BEFORE UPDATE ON "public"."gallery_images" FOR EACH ROW EXECUTE FUNCTION "public"."update_gallery_images_updated_at"();


--
-- Name: user_settings on_user_settings_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "on_user_settings_updated" BEFORE UPDATE ON "public"."user_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_user_settings_updated_at"();


--
-- Name: user_voices update_user_voices_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "update_user_voices_updated_at" BEFORE UPDATE ON "public"."user_voices" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
--
-- Name: gallery_images gallery_images_task_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."gallery_images"
    ADD CONSTRAINT "gallery_images_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "public"."video_tasks"("id") ON DELETE CASCADE;


--
-- Name: gallery_images gallery_images_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."gallery_images"
    ADD CONSTRAINT "gallery_images_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
--
-- Name: video_tasks video_tasks_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."video_tasks"
    ADD CONSTRAINT "video_tasks_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."video_tasks"("id");
...
ALTER TABLE ONLY "public"."video_tasks"
    ADD CONSTRAINT "video_tasks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
--
-- Name: user_settings Admins full access settings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins full access settings" ON "public"."user_settings" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: gallery_images Allow all gallery images access; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all gallery images access" ON "public"."gallery_images" USING (true) WITH CHECK (true);
...
--
-- Name: user_voices allow_all_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "allow_all_delete" ON "public"."user_voices" FOR DELETE USING (true);


--
-- Name: user_voices allow_all_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "allow_all_insert" ON "public"."user_voices" FOR INSERT WITH CHECK (true);


--
-- Name: user_voices allow_all_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "allow_all_select" ON "public"."user_voices" FOR SELECT USING (true);


--
-- Name: user_voices allow_all_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "allow_all_update" ON "public"."user_voices" FOR UPDATE USING (true);
...
--
-- Name: user_voices; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: objects Allow all uploads to generated-audio; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow all uploads to generated-audio" ON "storage"."objects" FOR INSERT WITH CHECK (("bucket_id" = 'generated-audio'::"text"));


--
-- Name: objects Allow authenticated read from generated-audio; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated read from generated-audio" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'generated-audio'::"text"));


--
-- Name: objects Allow public delete from generated-media; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public delete from generated-media" ON "storage"."objects" FOR DELETE USING (("bucket_id" = 'generated-media'::"text"));


--
-- Name: objects Allow public delete from generated-videos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public delete from generated-videos" ON "storage"."objects" FOR DELETE USING (("bucket_id" = 'generated-videos'::"text"));


--
-- Name: objects Allow public read from generated-audio; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public read from generated-audio" ON "storage"."objects" FOR SELECT TO "anon" USING (("bucket_id" = 'generated-audio'::"text"));


--
-- Name: objects Allow public read from generated-media; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public read from generated-media" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'generated-media'::"text"));


--
-- Name: objects Allow public read from generated-videos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public read from generated-videos" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'generated-videos'::"text"));


--
-- Name: objects Allow public uploads to generated-media; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public uploads to generated-media" ON "storage"."objects" FOR INSERT WITH CHECK (("bucket_id" = 'generated-media'::"text"));


--
-- Name: objects Allow public uploads to generated-videos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public uploads to generated-videos" ON "storage"."objects" FOR INSERT WITH CHECK (("bucket_id" = 'generated-videos'::"text"));
...
generated-media	generated-media	\N	2026-05-14 15:41:47.236033+00	2026-05-14 15:41:47.236033+00	t	f	\N	\N	\N	STANDARD
generated-audio	generated-audio	\N	2026-05-14 15:41:47.236033+00	2026-05-14 15:41:47.236033+00	t	f	\N	\N	\N	STANDARD
generated-videos	generated-videos	\N	2026-05-18 10:05:58.526386+00	2026-05-18 10:05:58.526386+00	t	f	\N	\N	\N	STANDARD
\.
